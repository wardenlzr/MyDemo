...
import ftp.bg.com.myftp.act.MainActivity;

/**
 * Created by pyj on 2016/11/23.
 */
...
public class FTP {
    ...
    public FTP() {
        this.hostName = "221.6.204.6";
        this.serverPort = 1221;
        this.userName = "tdkj";
        this.password = "tdkj";
    ...
    private boolean uploadingSingle(File localFile,
        ...
        try {
            ...
            Log.e("BG",connectException.getMessage());
            flag = false;
        }
