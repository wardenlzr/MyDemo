        ...
        OnScrollListener
{
    ...
    protected  OnMyScrollListener mScrollListener;
...
//                    if(mListView instanceof FloatBtnListView){
//                        setOnMyScrollListener((FloatBtnListView)mListView);
//                    }
    ...
    {
        return isBottom() && !isLoading && isHasMore && isPullUp();
    }
    ...
    public void setHasMoreData(boolean isHasMore)
    {
    ...
    public void setOnMyScrollListener(OnMyScrollListener mScrollListener){
    ...
    public static interface OnMyScrollListener
    {
        public void onScrollStateChanged(AbsListView view, int scrollState);
