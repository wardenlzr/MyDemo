...
public class PtrDemoHomeFragment extends BlockMenuFragment {
    ...
    protected void addItemInfo(ArrayList<BlockMenuFragment.MenuItemInfo> itemInfos) {
        ...
        itemInfos.add(newItemInfo(R.string.ptr_demo_block_grid_view_in_frame_layout, R.color.cube_mints_4d90fe, new OnClickListener() {

            @Override
            public void onClick(View v) {
                getContext().pushFragmentToBackStack(WithGridViewInFrameLayout.class, null);
            }
        }));
